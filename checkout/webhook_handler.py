...
class StripeWH_Handler:
    ...
    def handle_payment_intent_succeeded(self, event):
        ...
        # Retrieve the Stripe Charge object safely
        if 'charges' in intent and 'data' in intent['charges'] and len(intent['charges']['data']) > 0:
            ...
            print("No charges found in the payment intent")
            return HttpResponse(
