...
class CheckoutView(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if order_form.is_valid():
            ...
            return render(
                request, 'checkout/checkout.html', {'order_form': order_form}
            )
    ...
    def handle_line_items(self, order, basket):
        for item_id, item_data in basket.items():
            ...
            if product_type == 'edible':
                ...
                product = get_object_or_404(
                    SubscriptionProduct, id=common_product.product_id
                )
                quantity = item_data
...
class CheckoutSuccessView(View):
    def get(self, request, order_number, *arg, **kwargs):
        ...
        # email confirmation
        subject = (
            "Roo's Fudge Kitchen Order Confirmation - Your Latest Order"
        )
